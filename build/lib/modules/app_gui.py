...
class InterfaceUtilisateur:
    ...
    def __init__(self, root, gestionnaire_taches):
        ...
        self.label_description = tk.Label(cadre_entrees,
        ...
        self.supprimer_bouton = tk.Button(cadre_boutons, text="Supprimer",
    ...
    def supprimer_tache(self):
        ...
        if selection:
            ...
            self.afficher_taches()  # Met à jour après la suppression
    ...
    def changer_statut_tache(self):
        ...
        if selection:
            ...
            self.afficher_taches()  # Met à jour après modification du statut
    ...
    def afficher_taches(self):
        ...
        for tache in self.gestionnaire_taches.taches:
            ...
            self.tableau_taches.insert("", "end", values=(
                tache.nom, tache.description, terminee))
