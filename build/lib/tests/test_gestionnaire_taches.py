...
class TestGestionnaireTaches(unittest.TestCase):
    ...
    def test_sauvegarder_taches(self):
        ...
        # Assurez-vous qu'elle enregistre correctement les tâches
        # dans un fichier CSV
        pass
    ...
    def test_modifier_statut(self):
        ...
        with open('tests/modifier_statut_test_data.csv', 'w',
                  newline='') as file:
        ...
        gestionnaire.changer_statut_tache('Tâche 1')
        self.assertTrue(gestionnaire.taches[0].terminee)

        gestionnaire.changer_statut_tache('Tâche 2')
        ...
        gestionnaire.changer_statut_tache('Tâche 3')
